...
def before_model_callback(callback_context: CallbackContext, llm_request: LlmRequest) -> Optional[LlmResponse]:
    ...
    # Persist only JSON-serializable values in session state.
...
root_agent = LlmAgent(
    name = "before_after_model_agent",
    model="gemini-2.5-flash",
    description="An agent that demonstrates before and after model callbacks for logging and content filtering.",
    instruction="""
